            ...
            for event in workflow.stream(initial_state, config=config):
                for node_name, state_update in event.items():
                    ...
                    messages = {
                        ...
                        "memory_recall": "Recall node loaded prior dataset and run memory.",
                        "feature_profiler": "Feature profiler completed business-safe dataset understanding.",
